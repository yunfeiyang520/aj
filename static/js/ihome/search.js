...
//            alert($(this).attr('area-id'))
//            alert(location.search.replace('aid=' + aid, 'aid='+$(this).attr('area-id')))
//          点击区域，跳转到新的url
            var aid = location.search.split('=')[1].split('&')[0]
            location.href = location.search.replace('aid=' + aid, 'aid='+$(this).attr('area-id'))
